...
export const REGEXP_PHONE = /^1\d{10}$/;
...
// 阈值判断
export const REGEXP_THRESHOLD = /^(0|([1-9]\d{0,2}))$/;
...
// 姓名
export const REGEXP_USERNAME = /^[\u4e00-\u9fa5]{1,10}$/;

//地址
export const REGEXP_ADDRESS = /^[a-zA-Z0-9\u4e00-\u9fa5\-\:\_\.]{1,30}$/;
